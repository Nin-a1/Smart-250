  ...
  return (
    ...
    >
      <VStack align="stretch" gap={3}>
        ...
        {issue.photoBase64 && (
          <img
            src={issue.photoBase64} alt="issue"
...
export default function Dashboard() {
  ...
  useEffect(() => {
    setIssues(getIssues())
    const t = setInterval(() => setIssues(getIssues()), 5000)
        ...
        <HStack justify="space-between" flexWrap="wrap" gap={4}>
          <VStack align="start" gap={1}>
            ...
            <Text fontSize="sm" color="gray.500">
              All reported civic issues in Kigali · updates every 5 seconds
            </Text>
          </VStack>
          <Button
